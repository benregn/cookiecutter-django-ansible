...
.. code-block:: bash
    ...
    heroku run python {{cookiecutter.repo_name}}/manage.py syncdb --noinput --settings=config
    heroku run python {{cookiecutter.repo_name}}/manage.py migrate --noinput --settings=config
